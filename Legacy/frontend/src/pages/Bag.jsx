        ...
        {isEmpty ? (
          ...
          <div className="bag-content-grid">
            ...
            <div className="bag-items-column">
              ...
              <Link to="/shop" className="bag-continue-shopping-link">
            ...
            <div className="bag-summary-panel">
              <div className="bag-summary-card">
                ...
                <div className="bag-summary-cta-wrap">
                  <FlameButton type="button" onClick={() => navigate('/checkout')}>
                    Proceed to Checkout
                ...
                <div className="bag-summary-custom-nudge">
                  ...
                  <span>
                    ...
                    <Link to="/custom-order" className="bag-nudge-link">Start a custom order</Link>
                  </span>
                </div>
              </div>
            </div>
  ...
  return (
    ...
    >
      ...
      <div className="bag-empty-actions">
        ...
        <Link to="/custom-order" className="bag-empty-custom-link">
          <Sparkles size={14} />
      ...
      <div className="bag-empty-collections-preview">
        {[
          ...
          <Link to="/shop" key={i} className="bag-empty-preview-thumb">
