...
export function ProductDetail() {
  ...
  // Find and enrich product with luxury metadata
    ...
    <Layout>
      <section className="product-detail-container">
        ...
        <div className="product-detail-info-column">
          ...
          {/* Handcrafted discoverability badge */}
          <div className="product-handcrafted-story-badge">
            ...
            <Link to="/story" className="badge-learn-more-link">
          ...
          <div className="product-checkout-actions">
            ...
            <div className="product-secondary-actions-row">
              ...
              <Link to="/custom-order" className="product-action-link-btn">
                <Sparkles size={14} />
          ...
          <AnimatePresence>
            {bagToast && (
              ...
              >
                ...
                <Link to="/bag" className="product-bag-toast-link">View Bag →</Link>
              </motion.div>
            )}
          </AnimatePresence>
      ...
      {/* Mobile Sticky CTA checkout bar */}
      <AnimatePresence>
