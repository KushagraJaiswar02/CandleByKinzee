...
export function Layout({ children }) {
  ...
  // Close mobile nav when clicking a link (location change)
  ...
  return (
    <div className="site-shell">
      <header className={`site-header${scrolled ? ' is-scrolled' : ''}`}>
        <Link className="wordmark" to="/" onClick={closeMobileNav}>
          <motion.span
        ...
        <div className="header-actions">
          {!isMobile && (
            <>
              <Link aria-label="Track order" to="/track" onClick={closeMobileNav}><Search size={18} /></Link>
              <button
                type="button"
              ...
              <a
                aria-label="WhatsApp"
                href={`https://wa.me/${import.meta.env.VITE_WHATSAPP_NUMBER || '917000701579'}?text=${encodeURIComponent('Hello!')}`}
              >
          ...
          <Link aria-label="Your Bag" to="/bag" onClick={closeMobileNav} className="header-bag-link">
            <ShoppingBag size={18} />
          ...
          >
            <div className="mobile-nav-drawer-inner">
              <div className="mobile-nav-links">
                ...
                <Link to="/custom-order" className="mobile-nav-link mobile-nav-link--highlight" onClick={closeMobileNav}>
                  Request Custom Order
                </Link>
                <Link to="/track" className="mobile-nav-link" onClick={closeMobileNav}>
                  Track Order
                </Link>
                <button
                  type="button"
          ...
          <div className="footer-top">
            ...
            <div className="footer-brand">
              ...
              <div className="footer-socials">
                ...
                <a href={`https://wa.me/${import.meta.env.VITE_WHATSAPP_NUMBER || '917000701579'}`} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp"><MessageCircle size={18} /></a>
            ...
            <div className="footer-links">
              <h4>Collections</h4>
              <ul>
                <li><Link to="/collections/Floral candle bouquets">Floral Candles</Link></li>
                <li><Link to="/collections/Daisy & glass candles">Glass Candles</Link></li>
                <li><Link to="/collections/Candle bouquets & sticks">Candle Bouquets</Link></li>
                <li><Link to="/collections/Gift box sets">Gift Box Sets</Link></li>
                <li><Link to="/collections/Festive sweet collection">Festive Collection</Link></li>
                <li><Link to="/collections/Cocktail candle collection">Cocktail Glasses</Link></li>
              </ul>
            </div>
            ...
            <div className="footer-links footer-contact">
              ...
              <ul>
                ...
                <li><Link to="/custom-order">Bulk & Custom Orders</Link></li>
              </ul>
