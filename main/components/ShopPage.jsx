...
export function ShopPage() {
  ...
  const routeCategory = rawCategory ? decodeURIComponent(rawCategory) : '';
          ...
          <AnimatePresence>
            {filteredProducts.map((product, index) => {
              ...
              return (
                ...
                >
                  <Link href={`/products/${product._id}`} className="shop-product-tile-link">
          ...
          <div className="shop-editorial-custom-grid">
            ...
            <div className="shop-editorial-custom-content">
              ...
              <div className="shop-editorial-custom-action-area">
                <Link href="/custom-order" className="shop-editorial-custom-btn">
