      ...
      <Layout>
          ...
          <section className="section shop-by-collection">
            ...
            <div className="collection-grid">
              {COLLECTIONS.map((collection) => (
                <Link href={collection.link} key={collection.name} className="collection-card">
          ...
          <section className="section shop-by-occasion">
            ...
            <div className="occasions-grid">
              {OCCASIONS.map((occasion) => (
                <Link href={occasion.link} key={occasion.name} className="occasion-card">
        ...
        <section className="home-story-discover-section">
          <div className="home-story-discover-inner">
            ...
            <Link href="/story" className="home-story-discover-link">
